...
def NUM_ITEMS_PER_PATIENT(): return random.randint(
    50, 70)  # Number of items per patient
...
# Policy settings
POLICY_NUM_DEFECT_PER_JOB = 10  # Number of defective items to collect for rework
...
# Time interval to check defects (unit: minutes)
POLICY_CYCLE_TIME_TO_CHEK_DEFECT = 60
